...
})(["box-sizing:border-box;font-family:Work Sans;padding:20px;border:1px solid transparent;margin:0 auto;.person{text-transform:uppercase;font-size:12px;font-weight:500;color:", ";letter-spacing:1px;margin-top:20px;}.position{font-size:12px;font-weight:500;margin-top:0px;}&:hover{cursor:pointer;border:1px solid ", ";}transition:0.2s all linear;"], _styles_variables__WEBPACK_IMPORTED_MODULE_3__["colors"].red, _styles_variables__WEBPACK_IMPORTED_MODULE_3__["colors"].red);
...
})(["display:flex;flex-direction:column;height:800px;flex-wrap:wrap;.styled-box-cols{width:33.3%;margin-bottom:15px;box-sizing:border-box;}", " ", " ", " ", ""], _styles_media__WEBPACK_IMPORTED_MODULE_4__["default"].xl(_templateObject()), _styles_media__WEBPACK_IMPORTED_MODULE_4__["default"].lg(_templateObject2()), _styles_media__WEBPACK_IMPORTED_MODULE_4__["default"].md(_templateObject3()), _styles_media__WEBPACK_IMPORTED_MODULE_4__["default"].sm(_templateObject4()));


/***/ })

})
//# sourceMappingURL=testimonials.js.204ebdec15e7bd7bf0dd.hot-update.js.map
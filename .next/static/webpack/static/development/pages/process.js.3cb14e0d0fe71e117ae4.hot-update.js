...
var Process = function Process(props) {
  ...
  return __jsx(_components_layouts__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, "We never stop refining and improving operations, products and services."), __jsx(_styles_common__WEBPACK_IMPORTED_MODULE_2__["Body"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29
    },
    __self: this
  }, "The latest technology and proprietary processes are used to ensure all charges are captured, documented, submitted and paid. We rank in the top 5% in all of the most important MGMA benchmarks, and we continue to make strides in the areas of accuracy, turnaround time and revenue maximization.")))), __jsx(_styles_theme__WEBPACK_IMPORTED_MODULE_1__["ThemeProvider"], {
    ...
    __self: this
  }, "The latest technology and proprietary processes are used to ensure all charges are captured, documented, submitted and paid. We rank in the top 5% in all of the most important MGMA benchmarks, and we continue to make strides in the areas of accuracy, turnaround time and revenue maximization.")))));
};
...
//# sourceMappingURL=process.js.3cb14e0d0fe71e117ae4.hot-update.js.map
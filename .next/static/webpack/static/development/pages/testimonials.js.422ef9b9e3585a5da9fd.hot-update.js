...
})(["box-sizing:border-box;font-family:Work Sans;padding:20px;border:1px solid transparent;.person{text-transform:uppercase;font-size:12px;font-weight:500;color:", ";letter-spacing:1px;margin-top:20px;}.position{font-size:12px;font-weight:500;margin-top:0px;}&:hover{cursor:pointer;border:1px solid ", ";}transition:400ms all linear;"], _styles_variables__WEBPACK_IMPORTED_MODULE_3__["colors"].red, _styles_variables__WEBPACK_IMPORTED_MODULE_3__["colors"].red);
...
})(["display:flex;flex-direction:column;height:800px;flex-wrap:wrap;", ""], _styles_media__WEBPACK_IMPORTED_MODULE_4__["default"].xl(_templateObject()));


/***/ })

})
//# sourceMappingURL=testimonials.js.422ef9b9e3585a5da9fd.hot-update.js.map
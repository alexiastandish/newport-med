...
var StyledTestimonialsHero = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_styles_common__WEBPACK_IMPORTED_MODULE_0__["Hero"]).withConfig({
...
var StyledHeroTestimonial = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_styles_common__WEBPACK_IMPORTED_MODULE_0__["Box"]).withConfig({
  displayName: "styles__StyledHeroTestimonial",
  componentId: "ympidp-2"
})(["padding:10px 30px 20px 30px;box-sizing:border-box;width:100%;"]);
var StyledHeroTestimonialInfo = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
...
var StyledHeroTestimonialImage = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
...
var StyledTestimonialBox = Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_styles_common__WEBPACK_IMPORTED_MODULE_0__["Box"]).withConfig({
  displayName: "styles__StyledTestimonialBox",
  componentId: "ympidp-5"
})(["box-sizing:border-box;font-family:Work Sans;padding:20px;border:1px solid transparent;.person{text-transform:uppercase;font-size:12px;font-weight:500;color:", ";letter-spacing:1px;margin-top:20px;}.position{font-size:12px;font-weight:500;margin-top:0px;}&:hover{cursor:pointer;border:1px solid ", ";}transition:400ms all linear;"], _styles_variables__WEBPACK_IMPORTED_MODULE_2__["colors"].red, _styles_variables__WEBPACK_IMPORTED_MODULE_2__["colors"].red);
var StyledTestimonialsList = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "styles__StyledTestimonialsList",
  componentId: "ympidp-6"
})(["display:flex;flex-direction:column;height:800px;flex-wrap:wrap;"]);


/***/ })

})
//# sourceMappingURL=testimonials.js.dfe2e22e543408368b53.hot-update.js.map